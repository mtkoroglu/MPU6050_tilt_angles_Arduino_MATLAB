#include <Wire.h> // Arduino ile MPU6050 arasındaki haberleşme protokolü
...
void loop() {
  read_IMU();
  //Serial.print(imu.angleX); Serial.print(' '); Serial.print(imu.angleY); Serial.print(' '); Serial.println(imu.timeStamp);;
